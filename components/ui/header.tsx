          ...
          <div className="flex items-center space-x-3">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                {isSiteAdmin && (
                  <DropdownMenuItem asChild>
                    <Link href="/admin/firms" className="flex items-center space-x-2 cursor-pointer md:hidden">
                      <Shield className="h-4 w-4" />
                      <span>Admin</span>
                    </Link>
                  </DropdownMenuItem>
                ...
                {isFirmAdmin && (
                  <DropdownMenuItem asChild>
                    <Link href="/firm-admin" className="flex items-center space-x-2 cursor-pointer md:hidden">
                      <Shield className="h-4 w-4" />
                      <span>Firm Admin</span>
                    </Link>
                  </DropdownMenuItem>
