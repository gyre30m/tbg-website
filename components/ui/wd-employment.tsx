  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        <div>
          <Label htmlFor="employmentStatus">Employment status at the time of death*</Label>
        ...
        <div>
          <Label htmlFor="retirementAge">At what age was the plaintiff planning to retire?*</Label>
          <Input id="retirementAge" name="retirementAge" required />
        </div>

        <div>
          <Label htmlFor="careerTrajectory">What were the plaintiff&apos;s career trajectory expectations prior to death (promotions, pay raises, etc.)?*</Label>
