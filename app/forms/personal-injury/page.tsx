...
export default function PersonalInjuryForm() {
  ...
  const populateDemoData = () => {
    ...
    const textFields = [
      ...
      "preInjurySalary",
      "preInjuryDuties",
      "preInjuryAdvancements",
      "preInjuryOvertime",
      "preInjuryWorkSteady",
      "preInjuryLifeInsurance",
      "preInjuryIndividualHealth",
      "preInjuryFamilyHealth",
      "preInjuryRetirementPlan",
      "preInjuryInvestmentPlan",
      "preInjuryBonus",
      "preInjuryStockOptions",
      "preInjuryOtherBenefits",
      "preInjuryRetirementAge",
      "retirementAge",
      "preInjuryCareerTrajectory",
      "careerTrajectory",
      "preInjuryJobExpenses",
      "jobExpenses",
      "disabilityRating",
      "postInjuryJobTitle",
      "postInjuryEmployer",
      ...
      "postInjurySalary",
      "postInjuryDuties",
      "postInjuryAdvancements",
      "postInjuryOvertime",
      "postInjuryWorkSteady",
      "postInjuryLifeInsurance",
      "postInjuryIndividualHealth",
      "postInjuryFamilyHealth",
      "postInjuryRetirementPlan",
      "postInjuryInvestmentPlan",
      "postInjuryBonus",
      "postInjuryStockOptions",
      "postInjuryOtherBenefits",
      "postInjuryRetirementAge",
      "postRetirementAge",
      "postInjuryJobExpenses",
      "postJobExpenses",
      "additionalInfo",
      "matterNo",
      "defendant",
    ...
    textFields.forEach((fieldName) => {
      ...
      if (
        field &&
        personalInjuryDummyData[
          fieldName as keyof typeof personalInjuryDummyData
        ]
      ) {
        field.value = personalInjuryDummyData[
          fieldName as keyof typeof personalInjuryDummyData
        ] as string;
      }
    });
    ...
    const selectFields = [
      ...
      {
        name: "preInjuryEducation",
        value: personalInjuryDummyData.preInjuryEducation,
      },
      {
        name: "preInjuryEmploymentStatus",
        value: personalInjuryDummyData.preInjuryEmploymentStatus,
      },
      {
        name: "postInjuryEmploymentStatus",
        value: personalInjuryDummyData.postInjuryEmploymentStatus,
      },
      ...
      { name: "petCare", value: personalInjuryDummyData.petCare },
      {
        ...
        value: personalInjuryDummyData.indoorHousework,
      },
      { name: "mealPrep", value: personalInjuryDummyData.mealPrep },
      {
        name: "homeMaintenance",
        value: personalInjuryDummyData.homeMaintenance,
      },
      {
        name: "vehicleMaintenance",
        value: personalInjuryDummyData.vehicleMaintenance,
      },
  ...
  const handleDeleteConfirm = async (lastNameConfirmation: string) => {
    ...
    setIsDeleting(true);
    try {
      const result = await deletePersonalInjuryForm(
        currentFormId,
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
        <Tooltip>
          ...
          <TooltipContent>
            <p>
              {hasBeenSaved
                ? "Delete this saved form permanently"
                : "Clear all form data without saving"}
            </p>
          </TooltipContent>
        </Tooltip>
